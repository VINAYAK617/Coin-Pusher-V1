#if COINPUSHER_STANDALONE
namespace Neo.ComboGenerator.Core.Interfaces
{
...
namespace GameEngine
{
    ...
    {
        private static ICustomProfileSettings? _settings;

        public static ICustomProfileSettings Settings
        {
            get => _settings ?? throw new InvalidOperationException(
                "GameEngine.Engine.Settings is not configured. Assign the framework profile settings before generating or checking Coin Pusher tickets.");
